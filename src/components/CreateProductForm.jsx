...
function CreateProductForm() {
  ...
  const handleColorToggle = (colorId) => {
    setSelectedColors(prev => {
      ...
      if (imageInputRef.current && hasSelectedFile) {
          ...
          values.image = imageUrl; // Update the values object
        } catch (uploadError) {
  ...
  return (
    <div className="flex justify-center items-start min-h-screen py-4 sm:py-8 px-4 sm:px-6">
      <div className="w-full max-w-2xl">
        <Form {...form}>
          <form
            onSubmit={form.handleSubmit(onSubmit)}
            className="space-y-4 sm:space-y-6 bg-white p-4 sm:p-6 rounded-lg shadow-lg"
          >
            <div className="text-center mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Create New Product</h2>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2 sm:gap-3 mt-2">
                    {colors?.map((color) => (
                      <div
                        key={color._id}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter product name" className="text-sm" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
