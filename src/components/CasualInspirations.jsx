  ...
  return (
    <section className="px-4 lg:px-16 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-8 mt-8 md:mt-4 gap-4 md:gap-x-4">
      <div className="col-span-1 md:col-span-2 mb-6 md:mb-0">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">Casual Inspirations</h1>
        <p className="mt-3 md:mt-4 text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed">
          Our favorite combinations for casual outfit that can inspire you to
          apply on your daily activity.
        </p>
        <button className="mt-6 md:mt-8 text-center w-full sm:w-auto h-12 md:h-14 rounded-full border border-black flex items-center justify-center text-sm sm:text-base font-medium hover:bg-black hover:text-white transition-colors duration-200">
          BROWSE INSPIRATIONS
        </button>
      </div>
      <div className="relative col-span-1 md:col-span-3 h-60 sm:h-80 md:h-auto rounded-2xl overflow-hidden">
        <img
