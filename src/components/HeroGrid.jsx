function HeroGrid() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-4 lg:px-16 min-h-[50vh] sm:min-h-[60vh] md:min-h-[80vh] gap-4 mt-4">
      <div className="relative col-span-1 lg:col-span-2 rounded-2xl min-h-[300px] sm:min-h-[400px]">
        <img
      ...
      <div className="col-span-1 grid grid-rows-2 gap-4">
        <div className="rounded-2xl relative min-h-[150px] sm:min-h-[200px] md:h-auto">
          <img
